<tr align="left" width="558" style="border-collapse: collapse; border-spacing: 0;">
	<td width="548" height="110" colspan="2" style="border: 1px solid #ccc; padding: 25px">
		...
		<?php echo __('Your subscription at EZYcount for %s expires today !', h($company)); ?><br />
    ...
    array(
		...
		<?php echo __('From tomorrow onwards, you will not be able to edit your acccounting anymore.'); ?><br /><br />
